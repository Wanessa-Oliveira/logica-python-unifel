...
#TRUTHY / FALSY
# nem sempre voce precisa usar : variavel ==true 
#o if ja faz uma pergunta implicita com o metodo bool ()
print("\n")
nome = input("Qual o seu nome? ").strip()

if nome:# TRUE. internamente: bool (nome) == True
    print(f"Bem-vindo ao curso de lógica de Python, {nome}!!\n\n")
else: # nome =="" (False)
   print ("ERRO: O nome do usuario não pode ser vazio!! \n")
